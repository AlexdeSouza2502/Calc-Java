...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button buttonUmID, buttonDoisID, buttonTresID, buttonQuatroID, buttonCincoID,
            ...
            buttonPorcentoID, buttonMultiplicacaoID, buttonDivisaoID, buttonClearID, buttonDeleteID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonClearID = findViewById(R.id.buttonClearID);
        ...
        buttonClearID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
